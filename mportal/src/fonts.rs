...
pub fn configure_fonts(ctx: &eframe::egui::Context) {
    ...
    // extalight font
    fonts.font_data.insert(
        "Poppins-ExtraLight".into(),
        FontData::from_static(include_bytes!("../../asset/fonts/Poppins-ExtraLight.ttf")).into(),
    );
    ...
    fonts.families.insert(FontFamily::Name("Light".into()), vec!["Poppins-ExtraLight".to_owned()]);
    ...
    style.text_styles.insert(TextStyle::Heading, FontId::new(12.0, FontFamily::Name("ExtraLight".into())));
